...
def __build_model_gurobi2(self, X, y):
    ...
    c = model.addVars(T_L, vtype=GRB.CONTINUOUS, name="c")
    e = model.addVars(range(1, n + 1),T_L , vtyp = GRB.CONTINUOUS, name="e")
    l = model.addVars(range(1, n + 1),T_L , vtype = GRB.CONTINUOUS, name = "l")
    ...
    for i in range(1, n + 1):
       ...
       model.addConstr( l[i,t] >= -e[i,t] + y[i])
       model.addConstr( l[i,t] >=  e[i,t] - y[i])
       
       
       for t in T_L:

           model.addConstr( e[i,t] == c[t]*z[i,t] )
         

    model.setObjective(gp.quicksum(l[i,t] for i in range(1, n+1) for t in T_L),GRB.MINIMIZE)
...
# =============================================================================
            ...
            adv_acc_list.append([name,epsilon,depth,m2.adversarial_accuracy(X_test,y_test,epsilon = epsilon,options = {"disable_progress_bar" : True})])
            acc_list.append([name,epsilon,depth,m2.accuracy(X_test,y_test)])
            
            print("Training acc:",m2.accuracy(X,y),m2.accuracy(X,y))
            print("Acc: ROCT, ROCT2 of " + name + str(i))
            print(m2.accuracy(X_test,y_test),m2.accuracy(X_test,y_test))
            print("Adversarial acc: ROCT, ROCT2 of " + name + str(i))
            print(m2.adversarial_accuracy(X_test,y_test,epsilon = epsilon,options = {"disable_progress_bar" : True}),m2.adversarial_accuracy(X_test,y_test,epsilon = epsilon,options = {"disable_progress_bar" : True}))
            print()
...
#plt.title("100s runtime, No impossible combinations, Force in range same class samples to be equal, all depths of 3")
plt.xscale('linear')
plt.ylim(0,1.01)
plt.legend()
plt.tight_layout()
...
## adv acc 60s runtime 
[['haberman', 0.02, 0, 0.7419354838709677, 0.7419354838709677],
 ['haberman', 0.03, 0, 0.7419354838709677, 0.7419354838709677],
 ['haberman', 0.05, 0, 0.7419354838709677, 0.7419354838709677],
 ['blood-transfusion', 0.01, 4, 0.6466666666666666, 0.09333333333333334],
 ['blood-transfusion', 0.02, 3, 0.9066666666666666, 0.9],
 ['blood-transfusion', 0.03, 2, 0.9066666666666666, 0.9066666666666666],
 ['cylinder-bands', 0.23, 3, 0.5178571428571429, 0.5],
 ['cylinder-bands', 0.28, 2, 0.5178571428571429, 0.5178571428571429],
 ['cylinder-bands', 0.45, 0, 0.5178571428571429, 0.5178571428571429],
 ['diabetes', 0.05, 0, 0.6428571428571429, 0.6428571428571429],
 ['diabetes', 0.07, 0, 0.6428571428571429, 0.6428571428571429],
 ['diabetes', 0.09, 0, 0.6428571428571429, 0.6428571428571429],
 ['ionosphere', 0.2, 2, 0.9859154929577465, 0.9436619718309859],
 ['ionosphere', 0.28, 2, 0.9859154929577465, 0.971830985915493],
 ['ionosphere', 0.36, 1, 1.0, 1.0],
 ['banknote-authentication', 0.07, 4, 0.0, 1.0],
 ['banknote-authentication', 0.09, 3, 0.04727272727272727, 0.0],
 ['banknote-authentication', 0.11, 3, 0.0, 0.0],
 ['breast-cancer', 0.28, 3, 0.7591240875912408, 0.9343065693430657],
 ['breast-cancer', 0.39, 2, 0.8394160583941606, 0.8759124087591241],
 ['breast-cancer', 0.45, 1, 0.8175182481751825, 0.8175182481751825],
 ['wine', 0.02, 1, 0.693076923076923, 0.7023076923076923],
 ['wine', 0.03, 0, 0.693076923076923, 0.693076923076923],
 ['wine', 0.04, 2, 0.693076923076923, 0.693076923076923]]
...
#  ['blood-transfusion', 0.02, 3, 0.9066666666666666, 0.9],
#  ['blood-transfusion', 0.03, 2, 0.9066666666666666, 0.9066666666666666],
#  ['cylinder-bands', 0.23, 3, 0.5357142857142857, 0.5357142857142857],
#  ['cylinder-bands', 0.28, 2, 0.5178571428571429, 0.5178571428571429],
#  ['cylinder-bands', 0.45, 0, 0.5178571428571429, 0.5178571428571429],
#  ['diabetes', 0.05, 0, 0.6428571428571429, 0.6428571428571429],
#  ['diabetes', 0.07, 0, 0.6428571428571429, 0.6428571428571429],
#  ['diabetes', 0.09, 0, 0.6428571428571429, 0.6428571428571429],
#  ['ionosphere', 0.2, 2, 1.0, 1.0],
#  ['ionosphere', 0.28, 2, 1.0, 1.0],
#  ['ionosphere', 0.36, 1, 1.0, 1.0],
#  ['banknote-authentication', 0.07, 4, 0.0, 1.0],
#  ['banknote-authentication', 0.09, 3, 0.04727272727272727, 0.0],
#  ['banknote-authentication', 0.11, 3, 0.0, 0.0],
#  ['breast-cancer', 0.28, 3, 0.7591240875912408, 1.0],
#  ['breast-cancer', 0.39, 2, 0.8832116788321168, 0.948905109489051],
#  ['breast-cancer', 0.45, 1, 0.8905109489051095, 0.8905109489051095],
#  ['wine', 0.02, 1, 0.693076923076923, 0.7307692307692307],
#  ['wine', 0.03, 0, 0.693076923076923, 0.693076923076923],
#  ['wine', 0.04, 2, 0.693076923076923, 0.693076923076923]]
# =============================================================================
np.mean(np.array(acc_list)[:,3].astype(float) - np.array(acc_list)[:,4].astype(float))
np.mean(np.array(adv_acc_list)[:,3].astype(float) - np.array(adv_acc_list)[:,4].astype(float))
